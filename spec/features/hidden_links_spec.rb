...
feature "hidden links" do
  ...
  context "regular users" do
    ...
    scenario "New Ticket link is not present for a user without permission" do
      define_permission!(user, "view", project)
      visit project_path(project)
    ...
    scenario "Edit ticket link is not present for a user without permission" do
      ticket
      define_permission!(user, "view", project)
      visit project_path(project)
      click_link ticket.title
    ...
    scenario "Delete ticket link is present for a user with permission" do
      ticket  
      define_permission!(user, "view", project)
    ...
    scenario "Delete ticket link is not present for a user without permissison" do
      ticket  
      define_permission!(user, "view", project)
      visit project_path(project)
      click_link ticket.title
  ...
  context "admin users" do
    ...
    scenario "see the Delete Project link" do
      visit project_path(project)
      assert_link_for "Delete Project"
    end

    scenario "New Ticket link is shown" do
      visit project_path(project)
      assert_link_for("New Ticket")
    end
    ...
    scenario "Delete ticket link is present for admins" do
      ticket  
      visit project_path(project)
      click_link ticket.title
      assert_link_for "Delete Ticket"
